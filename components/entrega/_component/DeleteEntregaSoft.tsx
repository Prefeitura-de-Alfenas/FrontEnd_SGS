  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            Você está abusolutamente certo que quer desativar essa entrega?
          </DialogTitle>
          <DialogDescription>
            Se voce desativar essa entrega não contabilizara nos relatorios e
            anulara a validade do mesmo
          </DialogDescription>
        </DialogHeader>
        <div className="p-2">
          <DialogClose asChild>

...
function EditarPessoa({ usuario, pessoaId, responsavelId }: EditarPessoaProps) {
  ...
  useEffect(() => {
    ...
    setValue("parentesco", data ? data.parentesco : "", {
      shouldValidate: true,
    });
    setValue("escolaridade", data ? data.escolaridade : "", {
      shouldValidate: true,
    });
    setValue("renda", data ? data.renda : "", { shouldValidate: true });
    setValue("telefone", data ? data.telefone : "", { shouldValidate: true });
    setValue("whastapp", data ? data.whastapp : "", {
      shouldValidate: true,
    });
    setValue("ctpsassinada", data ? data.ctpsassinada : "", {
      shouldValidate: true,
    });
    ...
    setValue("observacao", data ? data.observacao : "", {
      shouldValidate: true,
    });
    setValue("observacaorestrita", data ? data.observacaorestrita : "", {
      shouldValidate: true,
    });
              ...
              {responsavelId && (
                <div className="mb-4">
                  ...
                  <Input
                    ...
                    id="parentesco"
                    {...register("parentesco")}
                    required={responsavelId ? true : false}
                    className="mt-1 p-2 w-full border rounded-md mb-2  bg-transparent"
                  />
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <Input
                  ...
                  required
                  readOnly={responsavelId ? true : false}
                  className="mt-1 p-2 w-full border rounded-md mb-2  bg-transparent"
                />
                {errors.cep?.message && (
